...
public:
    ...
    static void rectCustom( float x1, float y1, float x2, float y2, int thickness ); //coordenadas do retangulo x1, y1, x2, y2
    ...
    static void textBold(float x, float y, const char *t);
    static void textBold(float x, float y, const int i);
